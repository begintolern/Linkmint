-- Create and target a dedicated shadow schema for shadow DB replays
CREATE SCHEMA IF NOT EXISTS "shadow_gpt_20250919";
SET search_path = "shadow_gpt_20250919";

-- === Enums (guarded & schema-qualified) ===
DO $$ BEGIN
...
ALTER TABLE "shadow_gpt_20250919"."User"
  ADD CONSTRAINT "User_referralGroupId_fkey" FOREIGN KEY ("referralGroupId")
  REFERENCES "shadow_gpt_20250919"."ReferralGroup"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."User"
  ADD CONSTRAINT "User_referredById_fkey" FOREIGN KEY ("referredById")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."ReferralGroup"
  ADD CONSTRAINT "ReferralGroup_referrerId_fkey" FOREIGN KEY ("referrerId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."ReferralBatch"
  ADD CONSTRAINT "ReferralBatch_referrerId_fkey" FOREIGN KEY ("referrerId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."EventLog"
  ADD CONSTRAINT "EventLog_userId_fkey" FOREIGN KEY ("userId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."PayoutAccount"
  ADD CONSTRAINT "PayoutAccount_userId_fkey" FOREIGN KEY ("userId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."Payout"
  ADD CONSTRAINT "Payout_userId_fkey" FOREIGN KEY ("userId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."Commission"
  ADD CONSTRAINT "Commission_merchantRuleId_fkey" FOREIGN KEY ("merchantRuleId")
  REFERENCES "shadow_gpt_20250919"."MerchantRule"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."Commission"
  ADD CONSTRAINT "Commission_userId_fkey" FOREIGN KEY ("userId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."OverrideCommission"
  ADD CONSTRAINT "OverrideCommission_inviteeId_fkey" FOREIGN KEY ("inviteeId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."OverrideCommission"
  ADD CONSTRAINT "OverrideCommission_referrerId_fkey" FOREIGN KEY ("referrerId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."VerificationToken"
  ADD CONSTRAINT "VerificationToken_userId_fkey" FOREIGN KEY ("userId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."PayoutLog"
  ADD CONSTRAINT "PayoutLog_userId_fkey" FOREIGN KEY ("userId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."PasswordResetToken"
  ADD CONSTRAINT "PasswordResetToken_userId_fkey" FOREIGN KEY ("userId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."PinCredential"
  ADD CONSTRAINT "PinCredential_userId_fkey" FOREIGN KEY ("userId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."SmartLink"
  ADD CONSTRAINT "SmartLink_merchantRuleId_fkey" FOREIGN KEY ("merchantRuleId")
  REFERENCES "shadow_gpt_20250919"."MerchantRule"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "shadow_gpt_20250919"."SmartLink"
  ADD CONSTRAINT "SmartLink_userId_fkey" FOREIGN KEY ("userId")
  REFERENCES "shadow_gpt_20250919"."User"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;
