...
-- CreateEnum
CREATE TYPE "public"."MerchantStatus" AS ENUM ('PENDING', 'ACTIVE', 'REJECTED');
...
CREATE TABLE "public"."User" (
    ...
    "bonusEligibleUntil" TIMESTAMP(3),
    "bonusTier" INTEGER NOT NULL DEFAULT 0,
    "countryCode" VARCHAR(2) NOT NULL DEFAULT 'PH',
    "allowedCountries" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "blockedCountries" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "permanentOverrideBps" INTEGER NOT NULL DEFAULT 0,
...
-- CreateTable
CREATE TABLE "public"."SystemAuditRun" (
    "id" TEXT NOT NULL,
    "startedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "SystemAuditRun_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "ClickEvent_userId_createdAt_idx" ON "public"."ClickEvent"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "ClickEvent_merchantId_createdAt_idx" ON "public"."ClickEvent"("merchantId", "createdAt");

-- CreateIndex
CREATE INDEX "ClickEvent_source_createdAt_idx" ON "public"."ClickEvent"("source", "createdAt");
