...
const MOCK_SUGGESTIONS: Suggestion[] = [
  {
    ...
    merchantName: "Charles & Keith / Zalora PH (if approved)",
...
function generateAngles(s: Suggestion, isEN: boolean): string[] {
  ...
  if (isEN) {
    ...
    return [
      "Linawin kung para kanino talaga ‘yung product (anong klaseng tao, budget, at sitwasyon) para hindi generic ang dating.",
