  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <header className="border-b">
        <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            <Link href="/trust-center" className="hover:text-slate-600">Trust Center</Link>
      ...
      <section className="relative isolate">
        ...
        <div className="mx-auto max-w-6xl px-6 py-20 lg:py-28 grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="rounded-xl border p-5 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xs uppercase tracking-wider text-slate-500">Smart Link</div>
                  <div className="mt-1 font-semibold">Your unified tracking link</div>
                </div>
                <div className="h-10 w-10 rounded-md bg-gradient-to-br from-indigo-600 to-sky-500" />
              </div>
              <div className="mt-4 rounded-md bg-slate-50 p-3 text-sm font-mono text-slate-700 break-all">
        ...
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <Card
              ...
              body="Verify your email and get your dashboard. No approval required to start sharing."
            />
            <Card
              step="02"
              title="Turn any link into a Smart Link"
              body="Paste a product or site URL. We attach tracking and route to active partner programs."
            />
            <Card
              step="03"
              title="Share, track, and get paid"
              body="We attribute purchases, show earnings in real‑time, and handle payouts on schedule."
            />
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row items-start gap-10">
            <div className="flex-1">
              ...
              <p className="mt-3 text-slate-600">
                Invite friends and unlock a 90‑day 5% override on their approved commissions.
                We batch referrals in groups of three to keep things fair and fraud‑resistant.
              </p>
              <div className="mt-6">
                <Link
            ...
            <div className="flex-1 w-full">
              <div className="rounded-xl border bg-white p-5 shadow-sm">
                ...
                <ul className="mt-3 space-y-2 text-sm text-slate-600">
                  <li>• 3 verified invitees start your 90‑day window</li>
                  <li>• You earn 5% on their approved commissions</li>
                  <li>• TrustScore improves with healthy activity</li>
                </ul>
      ...
      {/* Trust strip */}
      <section className="border-t">
        <div className="mx-auto max-w-6xl px-6 py-16 grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            <h2 className="text-2xl font-semibold">Built for trust</h2>
            <p className="mt-3 text-slate-600">
              Linkmint is designed with transparency and safety in mind:
              clear attribution, email verification, fraud checks, and an audit‑friendly admin.
            </p>
          ...
          <div className="lg:col-span-5">
            <div className="rounded-xl border p-5 shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Real‑time health checks, reversible payouts, and manual overrides to keep creators safe.
              </p>
      ...
      <section className="border-t bg-slate-50">
        <div className="mx-auto max-w-6xl px-6 py-16 flex flex-col items-center text-center">
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <Link
              href="/login"
              className="inline-flex items-center rounded-md border px-5 py-3 hover:bg-white"
            >
