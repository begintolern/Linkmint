...
export default function AboutPage() {
  ...
  return (
    <>
      {/* SEO: AboutPage schema for brand/intent clarity */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": {
              ...
              "description":
                "Linkmint is a micro-affiliate platform that turns everyday sharing into real commissions with verified payouts via PayPal.",
            ...
            "breadcrumb": {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "About", "item": "https://linkmint.co/about" }
              ]
            }
          }),
        }}
