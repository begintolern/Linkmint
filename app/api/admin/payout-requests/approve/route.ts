// app/api/admin/payout-requests/approve/route.ts
...
export async function POST(req: Request) {
  try {
    ...
    const note = typeof body?.note === "string" ? body.note.slice(0, 250) : null;
    ...
    console.error("POST /admin/payout-requests/approve error:", e);
